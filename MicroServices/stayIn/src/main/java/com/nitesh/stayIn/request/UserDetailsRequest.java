...
public class UserDetailsRequest {
	...
	public UserDetailsRequest(
			...
			Integer pinCode, @NotNull Long mobileNo, @Email(message = "Invalid Email Address") String emailId,
			Long aadharCardNo) {
	...
	public String toString() {
		return "UserDetailsRequest [userDetailsId=" + userDetailsId + ", firstName=" + firstName + ", lastName="
				+ lastName + ", address=" + address + ", city=" + city + ", state=" + state + ", pinCode=" + pinCode
				+ ", mobileNo=" + mobileNo + ", emailId=" + emailId + ", aadharCardNo=" + aadharCardNo + "]";
	}
